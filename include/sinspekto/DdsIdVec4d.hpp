...
/**
   @brief Subscriber for DDS type IdVec4d as a QML element.
...
signals:
  /**
     ...
     This signal is connected to the QML DdsIdVec4dSubscriber::value property.
  ...
  */
  ...
  /**
     ...
     This signal is connected to the QML DdsIdVec4dSubscriber::timestamp property.
  ...
  */
  ...
  /**
     ...
     If DdsIdVec4dSubscriber is initialized with_listener=true, eventHeard() will be connected
...
private:
  std::unique_ptr<sinspekto::Reader<fkin::IdVec4d>> m_reader; ///< The DDS reader wrapper class.
  QString m_id; ///< Key identifier for topic instance.

};

/**
   @brief Publisher for DDS type IdVec4d as a QML element.
...
{
  Q_OBJECT
  Q_PROPERTY(QVector4D value READ value WRITE setValue NOTIFY valueChanged) ///< DDS 4d-vector as QVector4D QML property.
...
signals:
  /**
     ...
     This signal is connected to the QML DdsIdVec4dPublisher::value property.
...
private:
  std::unique_ptr<sinspekto::Writer<fkin::IdVec4d>> m_writer; ///< The DDS writer wrapper class.
};
