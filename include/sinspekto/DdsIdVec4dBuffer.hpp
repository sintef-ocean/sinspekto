#pragma once
/**
   @file DdsIdVec4dBuffer.hpp
   @brief QML enabled buffer class for Vec4d
*/
...
/**
   @brief Buffer class for IdVec4d or BatchIdVec4d
   ...
   .. code-block:: qml
     ...
     aBuffer.updateSeries(someSeries, FKIN.T, FKIN.W)
...
class DdsIdVec4dBuffer : public DdsBuffer
{
  ...
  Q_PROPERTY(QPointF rangeZ READ rangeZ NOTIFY rangeChanged) ///< Data range of variable z.
  Q_PROPERTY(QPointF rangeW READ rangeZ NOTIFY rangeChanged) ///< Data range of variable w.
...
public:
  ...
  */
  ...
  /**
     @brief Property accessor for z variable range.
  */
  QPointF rangeZ() const;
  /**
     @brief Property accessor for w variable range.
  */
